...
public class Alive implements IAlive{
	...
	public int checkMovementDOWN(int x, int y, ITile[][] tile, IBlock[][] block){
		int result;
	...
	public int checkMovementUP(int x, int y, ITile[][] tile, IBlock[][] block){
		int result;
		if(tile[x][y-1] != null && tile[x][y-1].getIsSolid() == true){
			result = 1;
			return result;
	...
	public int checkMovementLEFT(int x, int y, ITile[][] tile, IBlock[][] block){
		int result;
	...
	public int checkMovementRIGHT(int x, int y, ITile[][] tile, IBlock[][] block){
		int result;
		if(tile[x+1][y] != null && tile[x+1][y].getIsSolid() == true){
			result = 1;
			return result;
